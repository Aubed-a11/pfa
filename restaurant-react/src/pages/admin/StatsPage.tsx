  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <h2 className="font-semibold text-gray-900 mb-4">Répartition des ventes</h2>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
              <Pie
              ...
              >
                {(stats?.popularDishes?.slice(0, 5) ?? []).map((_, i) => (
        ...
        <div className="card">
          <h2 className="font-semibold text-gray-900 mb-4">Résumé financier</h2>
